...
func newData() []Question {
	return []Question{
		...
		{Hands: "77m3456789p22s789s", Answer: "7m", Page: 168, Comment: "浮かせ打ち 7mを浮かせて、一通・三色両天秤に構える"},
		{Hands: "77m11345678p3478s", Answer: "1p", Page: 168, Comment: "浮かせ打ち 1pを浮かせて、ソーズを引けばリーチ・一通が見えたらソーズターツ外し"},
		{Hands: "77m22456789p1134s", Answer: "1s", Page: 169, Comment: "浮かせ打ち ヘッドが複数の場合は浮かすさず連打前提"},
		{Hands: "3478m34566p33678s", Answer: "6p", Page: 170, Comment: "目先の受け入れと2次変化 後に3面チャンになれば、リャンメンを切る。3s切り三色狙いは非効率"},
		{Hands: "34m34566p2355678s", Answer: "2s", Page: 172, Comment: "目先の受け入れと2次変化 三色は無理には狙わないが、自然に狙える時は狙わないと損"},
